...
public class AvailableCommands {
    ...
    public static final Set<String> COMMANDS_WITH_CITY_ARG = new HashSet<>();
    public static final Set<String> COMMANDS_WITH_CITY_ID_ARGS = new HashSet<>();
    /**
    ...
    static {
        Collections.addAll(COMMANDS_WITHOUT_ARGS,
                ...
                "clear",
                "print_descending",
                "print_unique_car_code",
                "print_field_descending_area",
                "sort",
                "shuffle"
        );
        ...
        Collections.addAll(COMMANDS_WITH_CITY_ARG,
                "add"
        );
        Collections.addAll(COMMANDS_WITH_CITY_ID_ARGS,
                "update");
