...
public class CommandManager {
     ...
     * @param printFieldDescendingAreaCommand - команда вывода значения поля Area элементов коллекции в порядке убывания
     * @param printUniqueCarCodeCommand - команда вывода количества уникальных значений поля carCode элементов коллекции
    ...
    public CommandManager(AbstractCommand addCommand, AbstractCommand clearCommand, AbstractCommand executeScriptCommand, AbstractCommand exitCommand, AbstractCommand helpCommand, AbstractCommand infoCommand, AbstractCommand printDescendingCommand, AbstractCommand printFieldDescendingAreaCommand, AbstractCommand printUniqueCarCodeCommand, AbstractCommand removeByIdCommand, AbstractCommand removeFirstCommand, AbstractCommand showCommand, AbstractCommand shuffleCommand, AbstractCommand sortCommand, AbstractCommand updateByIdCommand) {
        ...
        AVAILABLE_COMMANDS.put(printFieldDescendingAreaCommand.getName(), printFieldDescendingAreaCommand);
        AVAILABLE_COMMANDS.put(printUniqueCarCodeCommand.getName(), printUniqueCarCodeCommand);
